export PATH=~/prj/utils-git:~/prj/utils-env:~/prj/utils-vcs:$PATH:~/prj/utils-cfg
...
export red_bright="\033[1;31;49m"
export red_back="\033[7;31;40m"
...
export yellow_back="\033[7;33;49m"
...
PS1="$cyan_back \w $green\$(branch_for_ps1)$magenta\$(remote_for_ps1)$cyan_bold$green\$(git_staged)$red\$(git_deleted)$norm$cyan_back \t > $norm \$(resettab)"
...
export PATH=$PATH:/Users/a.bysov/prj/utils-prj
